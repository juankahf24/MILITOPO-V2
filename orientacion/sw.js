/* MILITOPO Orientación · v2-f3b-stability-20260924 · PWA offline reforzada */
const MILITOPO_CACHE="militopo-v2-orientacion-v2-f3b-stability-20260924";
const RUNTIME_CACHE="militopo-v2-orientacion-runtime-v2-f3b-stability-20260924";
const CORE_ASSETS=["./","./index.html","./js/app.js","./js/app.js?v=v2-f3b-stability-20260924","./js/config/iof-symbols-f.js","./js/config/iof-symbols-baked.js","./js/config/plan-assets.js","./js/core/app-main.js","./js/pdf/pdf-professional.js","./js/results/results-v16.js","./js/results/results-classification-fix.js","./css/styles.css","./js/vendor/qr.js","./maps/index.json","./maps/valle-perdido.tif","./maps/el-valle-matizado.tif","../js/v2/firebase-config.js","../js/v2/bootstrap.js","../js/v2/auth/roles.js","../js/v2/auth/auth-ui.css?v=v2-f3b-stability-20260924","../js/v2/auth/auth-ui.js?v=v2-f3b-stability-20260924","../js/v2/auth/organizer-guard.js?v=v2-f3b-stability-20260924","../js/v2/data/invitations.js?v=v2-f3b-stability-20260924","../js/v2/data/participants-admin.js?v=v2-f3b-stability-20260924","../js/v2/data/events.js?v=v2-f3b-stability-20260924","../js/v2/data/orientation-structure.js?v=v2-f3b-stability-20260924","../js/v2/data/cloud-recovery.js?v=v2-f3b-stability-20260924","../js/v2/data/event-lifecycle.js?v=v2-f3b-stability-20260924","../js/v2/data/event-edit-lock.js?v=v2-f3b-stability-20260924","../js/v2/live/realtime-foundation.js?v=v2-f3b-stability-20260924","../js/v2/live/organizer-monitor.js?v=v2-f3b-stability-20260924"];
...
self.addEventListener("activate",event=>event.waitUntil((async()=>{if(self.registration.navigationPreload)try{await self.registration.navigationPreload.enable()}catch(_){}const keys=await caches.keys();await Promise.all(keys.filter(k=>(k.startsWith("militopo-v2-orientacion-")||k.startsWith("militopo-v2-page-snapshot-"))&&k!==MILITOPO_CACHE&&k!==RUNTIME_CACHE&&k!=="militopo-v2-page-snapshot-v2-f3b-stability-20260924").map(k=>caches.delete(k)));await self.clients.claim()})()));
...
self.addEventListener("message",event=>{
  if(event.data&&event.data.type==="MILITOPO_CLEAR_OLD_CACHES"){
    event.waitUntil((async()=>{const keys=await caches.keys();await Promise.all(keys.filter(k=>(k.startsWith("militopo-v2-orientacion-")||k.startsWith("militopo-v2-page-snapshot-"))&&![MILITOPO_CACHE,RUNTIME_CACHE,"militopo-v2-page-snapshot-v2-f3b-stability-20260924"].includes(k)).map(k=>caches.delete(k)))})());
  }
});
