/* MILITOPO PWA · v2-h6-2-manual-live-strictgps-progress-reset-20260925 · H6.1 siguiente baliza + GPS/QR */
const CACHE_NAME="militopo-v2-pwa-v2-h6-2-manual-live-strictgps-progress-reset-20260925";
const RUNTIME_CACHE="militopo-v2-pwa-runtime-v2-h6-2-manual-live-strictgps-progress-reset-20260925";
const APP_SHELL=["./","./index.html","./styles.css","./styles.css?v=v2-g3-recovery-wakelock-20260924","./app.js","./app.js?v=v2-g3-recovery-wakelock-20260924","./manifest.webmanifest","./icons/militopo-192.png","./icons/militopo-512.png","./icons/militopo-startup-1536.png","./icons/militopo-startup-premium-2048x3072.jpg","./js/v2/firebase-config.js","./js/v2/bootstrap.js","./js/v2/firebase/client.js?v=v2-g3-recovery-wakelock-20260924","./js/v2/auth/roles.js","./js/v2/auth/auth-ui.css?v=v2-g3-recovery-wakelock-20260924","./js/v2/auth/auth-ui.js?v=v2-g3-recovery-wakelock-20260924","./js/v2/data/invitation-inbox.js?v=v2-h6-2-manual-live-strictgps-progress-reset-20260925","./js/v2/maps/race-plan-history.js?v=v2-h4-1-runner-map-parity-20260925","./js/v2/live/runner-dashboard.js?v=v2-h6-2-manual-live-strictgps-progress-reset-20260925","./js/v2/live/runner-track-v2.js?v=v2-g3-recovery-wakelock-20260924","./js/v2/live/runner-gps-v2.js?v=v2-h6-2-manual-live-strictgps-progress-reset-20260925","./js/v2/live/runner-resilience-v2.js?v=v2-g3-recovery-wakelock-20260924","./js/v2/live/runner-controls-v2.js?v=v2-h6-2-manual-live-strictgps-progress-reset-20260925","./js/v2/live/runner-race-v2.js?v=v2-h6-2-manual-live-strictgps-progress-reset-20260925"];
const REMOTE_ASSETS=["https://unpkg.com/leaflet@1.9.4/dist/leaflet.css","https://unpkg.com/leaflet@1.9.4/dist/leaflet.js","https://unpkg.com/leaflet@1.9.4/dist/images/marker-icon.png","https://unpkg.com/leaflet@1.9.4/dist/images/marker-icon-2x.png","https://unpkg.com/leaflet@1.9.4/dist/images/marker-shadow.png","https://cdnjs.cloudflare.com/ajax/libs/proj4js/2.9.0/proj4.js","https://cdn.sheetjs.com/xlsx-0.20.2/package/dist/xlsx.full.min.js","https://cdn.jsdelivr.net/npm/xlsx-js-style@1.2.0/dist/xlsx.bundle.js","https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js","https://cdnjs.cloudflare.com/ajax/libs/FileSaver.js/2.0.5/FileSaver.min.js","https://cdn.jsdelivr.net/npm/qrcode@1.5.1/build/qrcode.min.js","https://cdn.jsdelivr.net/npm/jsqr@1.4.0/dist/jsQR.min.js","https://cdnjs.cloudflare.com/ajax/libs/jspdf/2.5.1/jspdf.umd.min.js"];
